...
class WebSocketMessageProcessor:
    ...
    async def _handle_connection_error(self, error: Exception) -> bool:
        ...
        """
        if WEBSOCKETS_AVAILABLE and isinstance(error, websockets.exceptions.ConnectionClosed):
            ...
            if await self.connection.reconnect():
                ...
                logger.info("Reconnected successfully - subscriptions need to be restored")
                return True
            else:
